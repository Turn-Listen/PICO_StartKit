	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 Color = ( _Float0 + tex2D( _TextureSample0, uv_TextureSample0 ) + _Vector0 + _Color0 ).rgb;
				float Alpha = 1;
...
ASEEND*/
//CHKSM=BA1134BB51A7F7EEC2A3C932CB8FB36EFC90AF1E